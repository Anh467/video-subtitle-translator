...
# Hard-burn ASS uses PlayResX/Y = actual video pixels (see srt_writer.write_ass_for_hard_burn).
# Font size % is computed from video height in burn_step — do not use a fixed 288 PlayRes here.
COLOR_MAP = {
    "white": "FFFFFF",
    "yellow": "FFFF00",
    "cyan": "00FFFF",
